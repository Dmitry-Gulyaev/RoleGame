...
using System.IO;
    ...
    public class Globals //
    {
        ...
        public void Reader()
        {
            ...
            String st;
            st = sr.ReadLine();
            Globals.Level = int.Parse(st);
            st = sr.ReadLine();
            Globals.Heal = int.Parse(st);
            //st = sr.ReadLine();
           // Globals.Medic = int.Parse(st);
            st = sr.ReadLine();
            Globals.Points = int.Parse(st);
            st = sr.ReadLine();
            Globals.Money = int.Parse(st);
            st = sr.ReadLine();
            Globals.Ammo = int.Parse(st);
            st = sr.ReadLine();
            // =====Загрузка данных об оружии=====
            Gun.PM = int.Parse(st);
            st = sr.ReadLine();
            Gun.Beretta = int.Parse(st);
            st = sr.ReadLine();
            Gun.Desert_Eagle = int.Parse(st);
            st = sr.ReadLine();
            Gun.AKS_74Y = int.Parse(st);
            st = sr.ReadLine();
            Gun.AK_105 = int.Parse(st);
            st = sr.ReadLine();
            Gun.AH_94 = int.Parse(st);
            st = sr.ReadLine();
            Gun.TOZ34 = int.Parse(st);
            st = sr.ReadLine();
            Gun.ShotGun = int.Parse(st);
            st = sr.ReadLine();
            Gun.Saiga_12 = int.Parse(st);
            st = sr.ReadLine();
            Gun.Dragunov_sniper_rifle = int.Parse(st);
            st = sr.ReadLine();
            Gun.Vintorez = int.Parse(st);
            st = sr.ReadLine();
            Gun.Gaus_Gun = int.Parse(st);
            //=======медресурсы
            st = sr.ReadLine();
            MedResource.medicine = int.Parse(st);
            st = sr.ReadLine();
            MedResource.bandage = int.Parse(st);
            st = sr.ReadLine();
            MedResource.analgesic = int.Parse(st);
            st = sr.ReadLine();
            MedResource.antidote = int.Parse(st);
            st = sr.ReadLine();
            //======cтатистика
            st = sr.ReadLine();
            Statistics.KillFlech = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillBoar = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillDogs = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillSnork = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillLeech = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillPoltergeist = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillController = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillByurer = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillChimera = int.Parse(st);
            st = sr.ReadLine();
            Statistics.KillGiant = int.Parse(st);
            st = sr.ReadLine();
            Statistics.SecretFarmCatacombs = int.Parse(st);
            sr.Close();
        }
        public void control()
        {
